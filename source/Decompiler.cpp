	...
	, m_ops(ops)
{
	if (m_op_names.empty())
	{
		...
		m_op_names[evm::OP_SQRT]			= "num_sqrt";
		...
		m_op_names[brepvm::OP_VEC2_CREATE_I]	= "vec2";
		m_op_names[brepvm::OP_VEC3_CREATE_R]	= "vec3_r";
		m_op_names[brepvm::OP_VEC3_CREATE_I]	= "vec3_i";
		m_op_names[brepvm::OP_VEC3_PRINT]		= "vec3_print";
		m_op_names[brepvm::OP_VEC3_ADD]			= "vec3_add";
		m_op_names[brepvm::OP_VEC3_SUB]			= "vec3_sub";
		m_op_names[brepvm::OP_VEC3_TRANSFORM]	= "vec3_trans";
		m_op_names[brepvm::OP_VEC4_CREATE_I]	= "vec4_i";
		m_op_names[brepvm::OP_MATRIX_CREATE]	= "mat4";
		m_op_names[brepvm::OP_MATRIX_ROTATE]	= "mat4_rot";
		m_op_names[brepvm::OP_MATRIX_TRANSLATE] = "mat4_trans";
		m_op_names[brepvm::OP_CREATE_PLANE]		= "plane";
		m_op_names[brepvm::OP_CREATE_PLANE_2]	= "plane_2";
		m_op_names[brepvm::OP_CREATE_CUBE]		= "cube";
		m_op_names[brepvm::OP_GET_X]			= "get_x";
		m_op_names[brepvm::OP_GET_Y]			= "get_y";
		m_op_names[brepvm::OP_GET_Z]			= "get_z";
		m_op_names[brepvm::OP_GET_W]			= "get_w";
		m_op_names[brepvm::OP_ADD]				= "add";
		m_op_names[brepvm::OP_SUB]				= "sub";
		m_op_names[brepvm::OP_MUL]				= "mul";
		m_op_names[brepvm::OP_DIV]				= "div";
		m_op_names[brepvm::OP_NEGATE]			= "neg";
		m_op_names[brepvm::OP_ABS]              = "abs";

		m_op_names[brepvm::OP_VECTOR_CREATE]	= "array";
		m_op_names[brepvm::OP_VECTOR_ADD]		= "array_add";
		m_op_names[brepvm::OP_VECTOR_CONCAT]	= "array_conn";
		m_op_names[brepvm::OP_VECTOR_GET]		= "array_get";
		m_op_names[brepvm::OP_VECTOR_FETCH_R]   = "array_get_r";
		m_op_names[brepvm::OP_VECTOR_SIZE]      = "array_size";

		m_op_names[brepvm::OP_CREATE_POLYFACE]		= "face";
		m_op_names[brepvm::OP_CREATE_POLYTOPE]		= "poly";
		m_op_names[brepvm::OP_CREATE_POLYFACE_2]	= "face2";
		m_op_names[brepvm::OP_CREATE_POLYTOPE_2]	= "poly2";
		m_op_names[brepvm::OP_POLYTOPE_SUBTRACT]	= "poly_sub";
		m_op_names[brepvm::OP_POLYTOPE_EXTRUDE]		= "poly_ext";
		m_op_names[brepvm::OP_POLYTOPE_CLIP]		= "poly_clip";
		m_op_names[brepvm::OP_POLYTOPE_SET_DIRTY]	= "poly_dirty";
		m_op_names[brepvm::OP_POLYPOINT_SELECT]		= "poly_sel";
		m_op_names[brepvm::OP_POLYFACE_SELECT]		= "face_sel";
		m_op_names[brepvm::OP_POLY_COPY_FROM_MEM]	= "poly_from_mem";

		m_op_names[brepvm::OP_TRANSFORM]		= "transform";
	}
}
